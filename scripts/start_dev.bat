...
start "AIIA Backend" cmd /k "cd /d "%BACKEND_DIR%" && "%PYTHON_EXE%" -m uvicorn src.main:app --host 127.0.0.1 --port 8000 --reload"

echo [INFO] Starting frontend on http://127.0.0.1:5173 ...
start "AIIA Frontend" cmd /k "cd /d "%FRONTEND_DIR%" && npm run dev"
